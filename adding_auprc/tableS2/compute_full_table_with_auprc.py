...
# =============================================================================
# ## table S2: IC95% computation via Bootstrap+Delong
# =============================================================================
# val_mode = "int_val"
val_mode = "ext_val"
k = 0
mean_gap = []
for source in ["amsterdam", "eicu", "hirid", "mimic4"]:
    print(f'{source}')
    path1 = "Y:/DDS_Rocheteau/BlendedLOS/results/dataset_benchmark_nomed/"+source+"_20/multitask/TPC/24-06-05_124933/test_predictions_los.csv"
    path2 = "Y:/DDS_Rocheteau/BlendedLOS/results/dataset_benchmark_nomed/"+source+"_20/multitask/TPC/24-06-05_124933/test_predictions_mort.csv"
...
for k, source in enumerate(sources):
    path2 = ("Y:/DDS_Rocheteau/BlendedLOS/results/dataset_benchmark_nomed/"
             + source + "_20/multitask/TPC/24-06-05_124933/test_predictions_mort.csv")
...
plt.tight_layout()
plt.savefig(f'pr_curves_patient_agregation{val_mode}.png', dpi=150, bbox_inches='tight')
plt.show()
